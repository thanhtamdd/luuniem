...
const getPriorityBadge = (priority: NotificationPriority) => {
  const priorityStyles = {
    ...
    [NotificationPriority.NORMAL]: 'bg-pink-100 text-pink-600 border-pink-300',
...
const NotificationCard: React.FC<NotificationCardProps> = ({
  ...
  return (
    <div className={`
      ...
      ${notification.isRead ? 'bg-white border-gray-200' : 'bg-pink-50 border-pink-200 shadow-sm'}
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center space-x-2 flex-1">
              ...
              {!notification.isRead && (
                <div className="w-2 h-2 bg-pink-500 rounded-full flex-shrink-0" aria-label="Unread notification" />
              )}
            </div>
            ...
            <div className="flex items-center space-x-2">
              {!notification.isRead && (
                <button
                  ...
                  className="inline-flex items-center px-2 py-1 text-xs font-medium text-pink-600 bg-pink-100 rounded hover:bg-pink-200 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-1 transition-colors"
