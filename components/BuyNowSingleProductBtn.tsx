...
const BuyNowSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-pink-500 hover:border-pink-500 border-1 font-normal bg-pink-500 text-white hover:bg-white hover:scale-110 hover:text-pink-500 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Buy Now
    </button>
  );
