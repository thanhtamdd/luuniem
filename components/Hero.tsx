...
const Hero = () => {
  return (
    <div className="h-[700px] w-full bg-pink-500 max-lg:h-[900px] max-md:h-[750px]">
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          ...
          <p className="text-white max-sm:text-sm">
           Memory Gift Shop – A place to cherish memories and share love.
           We offer a variety of unique and meaningful gifts and souvenirs, perfect for any special occasion.
           Visit us and find the perfect gift to express your feelings! 
          </p>
          <div className="flex gap-x-1 max-lg:flex-col max-lg:gap-y-1">
            <button className="bg-white text-pink-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              BUY NOW
            </button>
            <button className="bg-white text-pink-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              LEARN MORE
